...
namespace MRobot.Civilization.Civ5.Save
{
    public class GameSaver
    {
        ...
        private static readonly byte[] HeaderCrazyBytes = new byte[] { 0xB3, 0xB6, 0xB2, 0xC3, 0x9C, 0x43, 0x0B, 0x48, 0x85, 0x36, 0x1C, 0xF3, 0x9F, 0xCF, 0xC6, 0x82, 0x05, 0x00, 0x00, 0x00, 0x31, 0x2E, 0x30, 0x2E, 0x30, 0x2C, 0x15, 0x41, 0x0D, 0x8E, 0x94, 0x8F, 0x49, 0x8C, 0xDF, 0x69, 0x9D, 0x04, 0xC9, 0x8A, 0x95 };
        ...
        public virtual void Save(Stream stream)
        {
            ...
            output.Write(ConvertOptionEnumToSaveStr(_gameConfig.GamePace.Value).Bytes);
            ...
            output.WriteEmptyBlocks(2);
            output.Write(_gameConfig.Map.NumberOfCityStates);
            #endregion
            ...
            output.Write(GetExpectedCrazyMapSizeBytes(_gameConfig));
            #endregion
